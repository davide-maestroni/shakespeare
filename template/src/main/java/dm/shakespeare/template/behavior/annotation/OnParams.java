 ...
 * Envelop} and {@link dm.shakespeare.actor.Behavior.Agent Agent}. Such inputs will be injected at
 * the end of the received objects so to match the parameters order.<br>
