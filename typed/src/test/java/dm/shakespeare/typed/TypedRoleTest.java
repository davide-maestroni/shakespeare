...
import dm.shakespeare.typed.actor.ClassScript;
...
public class TypedRoleTest {
  ...
  public void typedBounce() {
    ...
    final TypedItf actor =
        stage.createActor(TypedItf.class, "test", new InstanceScript(new TypedRole()));
    ConstantConditions.notNull(stage.get("test")).dismiss();
    final TypedItf typed = TypedStage.back()
