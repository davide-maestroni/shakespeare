...
import dm.shakespeare.typed.actor.InstanceScript;
...
public class TypedStageTest {
  ...
  public void createTypedActorSameId() {
    ...
    assertThat(actor).isNotNull();
    assertThat(stage.get(id)).isNotNull();
    stage.createActor(id, new TestRole(new TestExecutorService()));
  }

  @Test(expected = NullPointerException.class)
  @SuppressWarnings("ConstantConditions")
  public void ffindAnyTypeNPE() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.createActor(List.class, new Script() {
  ...
  public void findAllType() {
    ...
    assertThat(stage.findAll(List.class)).hasSize(2);
    assertThat(stage.findAll(Collection.class)).hasSize(2);
  }

  @Test
  public void findAllTypeEmpty() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.createActor(List.class, new Script() {
    ...
    assertThat(stage.findAll(Set.class)).isEmpty();
  }

  @Test(expected = NullPointerException.class)
  @SuppressWarnings("ConstantConditions")
  public void findAllTypeEmptyNPE() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.findAll((Class<?>) null);
  }

  @Test(expected = NullPointerException.class)
  @SuppressWarnings("ConstantConditions")
  public void findAllTypeNPE() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.createActor(List.class, new Script() {
  ...
  public void findAnyType() {
    ...
    assertThat(stage.findAny(List.class)).isNotNull();
    assertThat(stage.findAny(Collection.class)).isNotNull();
  }

  @Test
  public void findAnyTypeEmpty() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.createActor(List.class, new Script() {
    ...
    assertThat(stage.findAny(Set.class)).isNull();
  }

  @Test(expected = NullPointerException.class)
  @SuppressWarnings("ConstantConditions")
  public void findAnyTypeEmptyNPE() {
    final TypedStage stage = new TypedStage(new Stage());
    stage.findAny((Class<?>) null);
  }
  ...
  public void typedActorDismiss() throws InterruptedException {
    final ArrayList<Object> list = new ArrayList<Object>();
    final TypedStage stage = new TypedStage(new Stage());
    List<Object> actor = stage.createActor(List.class, "test", new InstanceScript(list) {
    ...
    assertThat(stage.get("test")).isNotNull();
    assertThat(actor.add("test")).isTrue();
