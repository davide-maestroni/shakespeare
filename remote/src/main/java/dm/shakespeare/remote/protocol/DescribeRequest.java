...
public class DescribeRequest extends Remote {
  ...
  @NotNull
  public DescribeRequest addActors(final ActorRef actor) {
    if (mActors == null) {
  ...
  @NotNull
  public DescribeRequest addAllActors(@NotNull final Collection<? extends ActorRef> actors) {
    if (mActors == null) {
      mActors = new ArrayList<ActorRef>();
    }
  ...
  @NotNull
  public DescribeRequest putAllCapabilities(
  ...
  @NotNull
  public DescribeRequest putCapabilities(final String capabilityKey, final String capabilityValue) {
    if (mCapabilities == null) {
      mCapabilities = new HashMap<String, String>();
    }
  ...
  @NotNull
  public DescribeRequest withActors(final List<ActorRef> actors) {
    mActors = actors;
    return this;
  }

  @NotNull
  public DescribeRequest withCapabilities(final Map<String, String> capabilities) {
    mCapabilities = capabilities;
    return this;
  }

  @NotNull
  public DescribeRequest withProtocolVersion(final int protocolVersion) {
    mProtocolVersion = protocolVersion;
    return this;
  }
}
